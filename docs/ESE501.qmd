...
1.  [Where are we in addressing climate change?](news)

  - Emissions (bad news)
  - Technology (good news)
  - Public opinion (good news)
  
1. How to think about [recent policy changes](policy)
1. How the U.S. federal government makes policy
2. How money and lobbying affect policy
3. How advocacy and fights over issue framing affect policy 
...
`political economy`: explanations of behavior rooted in how economic power shapes political behavior and political power shapes economic behavior
...
Big push from this administration to increase participation and democratize agency decision-making, but the aim is unclear.
...
## {background-image="https://u4d2z7k9.rocketcdn.me/wp-content/uploads/2024/03/PR_fig3_timeseries_era5_2t_daily_anomalies_relative_to_preindustrial_1940-2024-1024x663.png" background-size="contain"}
...
There may be lessons here for how powerful incumbent interests respond to the IRA and, especially if we get more regulatory legislation.
:::
...
manufacturing, agriculture, and certain service
